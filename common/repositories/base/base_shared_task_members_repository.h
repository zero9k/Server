...
public:
	...
	static SharedTaskMembers GetSharedTaskMembers(
	...
	static int InsertMany(
		Database& db,
		const std::vector<SharedTaskMembers> &entries
	)
	{
	...
	static std::vector<SharedTaskMembers> GetWhere(Database& db, const std::string &where_filter)
	{
		std::vector<SharedTaskMembers> all_entries;
